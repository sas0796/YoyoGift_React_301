...
const schema = Yup.object().shape({
  ...
  cardCount: Yup.number("Count should be of number type only!").required("Count is required!").positive("Count must be a positive integer!").integer().moreThan(10, "Count should be more than 10!"),
